...
import {Navbar, Collapse, Typography, IconB, Collapseutton,} from "@material-tailwind/react";
import { useLocation } from "react-router-dom";
import { IconButton } from '@mui/material';



export function ApplicantMenuBar() {
  ...
  const menuItems = [
    ...
    { heading: 'Contact Us', link: '/payments' },
    { heading: 'Proposed Properties', link: '/contact-us' }
  ];
