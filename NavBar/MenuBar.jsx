...
export function MenuBar() {
  ...
  useEffect(() => {
    ...
    const pathToItem = {
      "dashboard": "Dashboard",
      "view_real_est_developers": "Developers",
      "tenant": "Properties", // Note: 'tenant' is used for both Properties and Tenants
      "app-submissions": "Applications",
      "tenant": "Tenants", // Note: 'tenant' is used for both Properties and Tenants
      "ai-query": "AI Query",
    };
    
    setActiveItem(pathToItem[currentPath] || "Applications");
  }, [location.pathname]);

  const menuItems = [
    { heading: 'Dashboard', link: 'dashboard' },
    { heading: 'Developers', link: 'view_real_est_developers' },
    { heading: 'Properties', link: 'tenant' },
    { heading: 'Applications', link: 'app-submissions' },
    { heading: 'Tenants', link: 'tenant' },
    { heading: 'AI Query', link: 'tenant' }
  ];
